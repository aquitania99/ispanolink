				...
				<div class="package  <?php echo $product->is_featured()  == 'yes' ? 'package--featured' : ''; ?>">
					...
					<div class="package__price">
						<?php if ( $product->price ){
							if ( $product->get_title() === 'Single') {
								echo wc_price( $product->price  ).'<span style="font-size:small"> /month</span>';
							} else { echo wc_price( $product->price  ).'<span style="font-size:small"> /year</span>'; }
