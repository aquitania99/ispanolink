...
//	$fields['_company_twitter']['priority'] = 2.6;
	$fields['_company_facebook']['priority'] = 2.6;
...
//		'type'        => 'number',
		'placeholder' => esc_html__( 'e.g +61-898-4364', 'listable' ),
//		'description' => ''
		'priority'    => 2.4
	);
...
//	$fields['job']['job_description']['type']        = 'textarea';
	...
	$fields['job']['job_location']['placeholder'] = esc_html__( 'e.g 42 Wallaby Way, Sydney', 'listable' );
	...
	$fields['company']['company_website']['placeholder'] = esc_html__( 'e.g yourwebsite.com, Sydney', 'listable' );
	$fields['company']['company_website']['description'] = sprintf( '<span class="description_tooltip left">%s</span>', esc_html__( 'Add accurate information so people can contact you easily', 'listable' ) );



	// temporary unsets
	$fields['company']['company_video'];
