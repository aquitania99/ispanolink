...
class SendGrid_NLVX_Widget extends WP_Widget {
    ...
    private function display_form() {
      echo '<form method="post" id="sendgrid_mc_email_form" class="mc_email_form form-inline" action="#sendgrid_mc_email_subscribe">';
...
#      echo '</div>';
#      echo '</form>';
      echo '<div class="sendgrid-mc-field form-group">';
      //echo '<label for="sendgrid_mc_email">Email<sup>*</sup> :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>';
      echo '<input id="sendgrid_mc_email" name="sendgrid_mc_email" class="form-control" style="width:20em" placeholder="Enter your email" value="" required/>';
      echo '</div>';

      echo '<div class="sendgrid-mc-field form-group" style="padding-right:1em"></div>';
      echo '<button type="submit" class="btn btn-warning" style="background-color:#f79f07; margin-top:1em;" id="sendgrid_mc_email_submit" value="Subscribe">Subscribe</button>';
      //echo '<div class="sendgrid-mc-button">';      
      //echo '<input type="submit" id="sendgrid_mc_email_submit" value="Subscribe" />';
      //echo '</div>';
      echo '</form>';
